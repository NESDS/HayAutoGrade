...
2. Приведи КОРОТКИЙ пример, РЕЛЕВАНТНЫЙ для должности пользователя из контекста, показывающий ВСЕ СТОРОНЫ конфликта
...
- Будь кратким - максимум 3-4 предложения на всё объяснение
- В примере раскрой конфликт С РАЗНЫХ СТОРОН, показывая противоречие между всеми указанными вопросами
...
💡 ПРИМЕР:
[1-2 предложения - конкретный пример для должности пользователя, раскрывающий ВСЕ стороны конфликта]
